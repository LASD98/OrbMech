function [alpha, delta, lon, lat, Y] = groundTrackJ2(state, lonG0, time, omE, mu)

% Considering J2 effects, computes right ascension, declination, latitude,
...
[T,Y] = ode113(@(t,y) orbitJ2(t,y,mu), time, [rr;vv], opts);

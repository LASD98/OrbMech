...
addpath(genpath('MATLAB functions\')), addpath(genpath('functions\')), addpath('textures\')
...
legend('','Incoming hyperbola','Outcoming hyperbola','Asymptote for incoming hyperbola','Asymptote for outcoming hyperbola','Location','northeast','FontSize',18)
xlabel("$x [R_V]$",'interpreter','Latex'); ylabel("$y [R_V]$",'interpreter','Latex'); zlabel("$z [R_V]$",'interpreter','Latex','FontSize',18)
axis equal
grid on
